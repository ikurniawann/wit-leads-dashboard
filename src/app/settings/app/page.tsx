      ...
      <main className="md:ml-72 pt-16 pb-12 px-4 md:px-6">
        <div>
          ...
          <div className="mb-6">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-wit-text mb-1 md:mb-2">Application Settings</h1>
            <p className="text-sm md:text-base text-wit-muted">Configure your dashboard preferences</p>
          </div>
