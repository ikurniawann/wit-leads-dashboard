...
export default function RequirementPlanningPage() {
  return (
    <div className="min-h-screen theme-content">
      ...
      <main className="md:ml-72 pt-16 pb-12 px-4 md:px-6">
        <div className="text-center py-12">
          ...
          <h1 className="text-2xl font-bold text-wit-text mb-2">Requirement Planning</h1>
          <p className="text-wit-muted mb-4">Annual headcount & workforce planning</p>
